...
from .types import Background, CompanyDocument, EncodedDocument
...
class DocumentDataset(HDF5Dataset[CompanyDocument, EncodedDocument[TaskT]]):
    """Dataset implementation for storing CompanyDocuments as records. The augmentation
...
class ShardedDocumentDataset(ConcatDataset, Generic[TaskT]):
    ...
    def __init__(
        ...
        directory: Path,
        encoding: str = "utf-8",
        transform: Optional[Callable[[CompanyDocument], EncodedDocument[TaskT]]] = None,
    ):
