...
from .types import CompanyDocument


def drop_tokens(document:CompanyDocument, p) -> CompanyDocument:
...
def align_document(document: CompanyDocument) -> CompanyDocument:
...
def add_noise2time(document: CompanyDocument) -> CompanyDocument:
...
def shuffle_sentences(document: CompanyDocument) -> CompanyDocument:
